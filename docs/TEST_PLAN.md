...
Step 1 test-design baseline, updated after Step 6. Header/framing scenarios
...
have [Step 6 evidence](reviews/0005-session-command-codecs.md). Messaging, endpoint
